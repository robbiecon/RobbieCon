...
unlocked to sign the Robbiecon-Qt.app bundle.
...
allowing somebody to distribute a Robbiecon-Qt.app or robbiecon-qt-setup.exe with a valid
...
that the robbiecon-qt.exe file inside the installer had not been tampered with.
