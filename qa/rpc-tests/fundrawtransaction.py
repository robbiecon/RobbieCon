...
class RawTransactionsTest(RobbieconTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid robbiecon address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid robbiecon address" in e.error['message'])
