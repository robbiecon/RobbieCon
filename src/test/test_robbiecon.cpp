...
#define BOOST_TEST_MODULE Robbiecon Test Suite

#include "test_robbiecon.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_robbiecon_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
