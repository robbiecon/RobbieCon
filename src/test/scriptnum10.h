...
#ifndef ROBBIECON_TEST_SCRIPTNUM10_H
#define ROBBIECON_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Robbiecon Core 0.10.0, for cross-comparison.
 */
public:
