...
#if defined(NDEBUG)
# error "Robbiecon cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Robbiecon Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s ROB additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("robbiecon-scriptch");
                     ...
                     ++mi)
                {
                    ...
                    else if (!fMissingInputs2)
                    {
                        ...
                        if (orphanTx.wit.IsNull() && !stateDummy.CorruptionPossible()) {
                            ...
                            // See https://github.com/robbiecon/robbiecon/issues/8279 for details.
                            assert(recentRejects);
