    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return RobbieconUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, RobbieconUnits::separatorNever);
            else
                return RobbieconUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
    }
...
{
    return (this->walletModel->getOptionsModel() != NULL) ? tr("Requested") + " ("+RobbieconUnits::name(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
