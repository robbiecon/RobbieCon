...
#ifndef ROBBIECON_QT_ROBBIECONUNITS_H
#define ROBBIECON_QT_ROBBIECONUNITS_H
...
/** Robbiecon unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class RobbieconUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit RobbieconUnits(QObject *parent);

    /** Robbiecon units.
      @note Source: https://en.robbiecon.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        ROB,
...
typedef RobbieconUnits::Unit RobbieconUnit;

#endif // ROBBIECON_QT_ROBBIECONUNITS_H
