 ...
 */
#ifndef ROBBIECON_UTIL_H
#define ROBBIECON_UTIL_H
...
extern const char * const ROBBIECON_CONF_FILENAME;
extern const char * const ROBBIECON_PID_FILENAME;
...
{
    std::string s = strprintf("robbiecon-%s", name);
