 ...
 * between robbiecond, and robbiecon-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("robbiecon-shutoff");
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-conf=<file>", strprintf(_("Specify configuration file (default: %s)"), ROBBIECON_CONF_FILENAME));
    if (mode == HMM_ROBBIECOND)
    {
#if HAVE_DECL_DAEMON
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), ROBBIECON_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/robbiecon/robbiecon>";
    const std::string URL_WEBSITE = "<https://robbieconcore.org>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("robbiecon-loadblk");
...
/** Sanity checks
 *  Ensure that Robbiecon is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Robbiecon version %s\n", FormatFullVersion());
}

/** Initialize robbiecon.
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single Robbiecon process is using the data directory.
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(GetArg("-conf", ROBBIECON_CONF_FILENAME)).string());
