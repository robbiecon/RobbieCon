...
This document provides guidelines for internationalization of the Robbiecon Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `robbiecon_en.ts` remains unchanged.
